...
export const MENU_NAME_LABELS: Record<MenuNameType, string> = {
  ...
  [MENU_NAMES.ACCESS_MANAGEMENT]: '权限管理',
  [MENU_NAMES.USER_MANAGEMENT]: '用户管理',
  [MENU_NAMES.ROLE_MANAGEMENT]: '角色管理',
  [MENU_NAMES.DEPT_MANAGEMENT]: '部门管理',
  [MENU_NAMES.MENU_MANAGEMENT]: '菜单管理',
